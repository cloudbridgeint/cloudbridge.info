...
UPDATE university_directory SET
  ...
  founded = '1843',
  overview = 'Birmingham City University traces its roots to the Birmingham College of Art in 1843, became a polytechnic in 1971 and gained university status in 1992. It is one of the UK’s larger universities, with more than 31,000 students drawn from over 100 countries.
...
UPDATE university_directory SET
  ...
  founded = '1884',
  overview = 'Bangor University was founded in 1884 and received its Royal Charter in 1885, making it one of the older degree-awarding institutions in the UK. It sits in the small coastal city of Bangor in North Wales, between the mountains of Eryri (Snowdonia) and the Menai Strait.
...
UPDATE university_directory SET
  ...
  founded = '1888',
  overview = 'Abertay University is in the centre of Dundee, Scotland. It opened in 1888 as Dundee Technical Institute and became a university in 1994, and it is a small, specialised institution rather than a broad one.
...
UPDATE university_directory SET
  ...
  founded = '1870',
  overview = 'De Montfort University began as the Leicester School of Art in 1870 and became a university in 1992. It is named after Simon de Montfort, the 13th-century Earl of Leicester who called the first English parliament in 1265. Today it has over 23,000 students and a single campus in the centre of Leicester.
...
-- A slug for every remaining entry, so no profile link is broken while the
